...
Reads `{analysis_root}/degradation/{eer_matrix,eer_sd}.csv` and writes
...
def main(argv=None):
    ap = argparse.ArgumentParser(
        prog="python -m spoof_superb.analysis.create_heatmap",
        description=__doc__,
    ...
    in_dir = Path(args.in_dir or os.path.join(root, "degradation"))
